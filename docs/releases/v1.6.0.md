...
- **libbox: 1.12.12 → 1.13.11** ([§060](../spec/tasks/060-libbox-1-13-migration/spec.md), бывший feature §039). Major architectural changes:
...
- `test/services/builder/dns_rules_resolver_test.dart` — auto-discovery + orphan cleanup for §033 / §061 (бывший feature §041).
