...
| [DONATE.md](DONATE.md) · [RU](DONATE.ru.md) | Supporting the project (§362): crypto, Boosty, and how to help without money. The in-app popup is sourced from `app/assets/donate.json` |
