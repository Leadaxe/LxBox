...
| Дата | 2026-04-19 |
| Зависимости | [`026 parser v2`](../026%20parser%20v2/spec.md) (заменил v1 generator — см. [`../../tasks/058-config-generator-wizard-v1-superseded/`](../../tasks/058-config-generator-wizard-v1-superseded/)), [`020`](../020%20security%20and%20dpi%20bypass/spec.md) |
