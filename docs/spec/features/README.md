...
| 248 | [`248 detour-channels/`](248%20detour-channels/) | Detour-каналы: канал §125 с галкой «Use as detour» как переключаемая прослойка для detour серверов/папок/подписок (⚙, исключён из целей правил, edge-strip detour-циклов на билде) | Реализовано |
