...
>
> Документ оставлен **как reference для шаблона и исторический контекст сборки** — не использовать раздел "ConfigBuilder" как actual reference для актуального кода.
