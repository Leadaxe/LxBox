...
| Поле | Значение |
|------|----------|
| Статус | 🚫 Закрыто (не актуально) — оставшийся скоп снят |

> **Закрыто.** Базовый Debug Screen + уровень логирования реализованы; задуманный
> «продвинутый log viewer» (фильтрация/поиск/экспорт внутри приложения) больше не
> актуален — потребность в live-диагностике закрыта профайлером
> ([§044 profiler](../044%20profiler/spec.md) / §168+ на CommandClient: Live-соединения,
> routing, DNS) и Debug API ([`/logs`](../../../api/debug-api-reference.md)). Отдельный
> in-app log-viewer развивать не будем.
