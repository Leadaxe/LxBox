...
> **v2 (§356):** формат и логика заменены — лента сообщений с i18n,
> версионный повторный показ (`since_version`), baseline-отсчёт порогов,
> нативный учёт наработки. См. `docs/spec/tasks/356-support-message-feed.md`.
> Ниже — историческое описание v1.

| Поле | Значение |
|------|----------|
| Тип | Feature (новый сервис + диалог на старте) |
| Статус | **SUPERSEDED §356** (v1 — DONE, входит в v2.0.0) |
