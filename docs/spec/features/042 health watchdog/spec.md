...
| Статус | Draft |
| Дата | 2026-05-05 |
| Связанные | [`030 vpn reload button`](../../tasks/030-vpn-reload-button.md), [`031 reset network api`](../../tasks/031-reset-network-api.md), [`031 debug api`](../031%20debug%20api/spec.md) |
