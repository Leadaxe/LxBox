...
- **Switch в leading вместе с protocol-иконкой** (решение пользователя
  2026-07-18: «как везде слева»): Row(Switch, иконка) — иконка сохранена,
  она несёт информацию (протоколы вперемешку; у folder-строк её не было).
  Глушение цветом как у папок.
