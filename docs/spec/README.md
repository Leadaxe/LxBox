...
- **Фичи** — имя папки: префикс номера (`001`, `002`, …), пробел, название из нескольких слов через пробел. Основной файл — `spec.md`. В `features/` лежат **только живые** продуктовые / архитектурные концепции (см. [`features/README.md`](features/README.md)).
