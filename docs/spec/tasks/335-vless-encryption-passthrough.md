...
**Статус:** ✅ реализовано (`082f5db6`), вошло в v2.19.1 (ядро `v1.14.0-lx.18`,
SPEC 032) · device-замер на подписке с PQ-слоем: +12 живых узлов (ws 7/8,
grpc 5/5), подписка 42 → 53 из 76 — см. `docs/KERNEL.md`
