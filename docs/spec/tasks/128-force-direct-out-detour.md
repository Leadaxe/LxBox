...
> ⚠️ **Коллизия номера §128** (параллельные сессии). Это «§128-detour». Второй файл под тем же
> номером — [`128-jni-callback-crash-android10.md`](128-jni-callback-crash-android10.md) («§128-jni»).
