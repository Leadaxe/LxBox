...
**Статус:** ✅ Реализовано (позже, §044) — DNS-legacy лог-питатель + inferred-эвристики выпилены (traffic_profiler.dart, остались только tombstone-комментарии). Шапка «Draft» устарела.
