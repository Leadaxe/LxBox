...
| Поле | Значение |
|------|----------|
| Статус | ✅ Реализовано частично (living-реестр) — поведенческий блок закрыт: G1 ✅ · A1/A2 ✅ · G2 ✅ ([093](093-detour-by-isdetour.md)/[094](094-emoji-tags-node-settings-tabs.md)) · F2 skip. Остаток осознанно отложен: E1 (SRS-cache), D1–D3 (VPN recovery — §087 done, §088 on-hold), B/C (брокеры/роутинг). Реестр и журнал ниже. |
