...
| Поле | Значение |
|------|----------|
| Статус | **In progress** — реестр частично исполнен (2026-06-09): G1 ✅ ([092](092-update-dismiss-wire.md)) · A1/A2 ✅ (форматтеры) · G2 ✅ ([093](093-detour-by-isdetour.md) + [094](094-emoji-tags-node-settings-tabs.md)) · F2 — skip (решение юзера). Осталось: E1 (SRS-cache, device-verify) · D1–D3 (VPN recovery) · B/C (брокеры/роутинг). Порядок выбирает юзер; реестр и журнал — ниже. |
