...
| Коммиты | 00de8b9e, e96e251d, 9235987a, 94c6eac5, 726f0406, f2c3dfca, e61dc45c (+ merge develop 4713576c, d2637807); второй заход: e013c3ba, 78eaa954, d3781509, e2e29a64, 00be38cd, 539148e6; UI-волна: a4fbc21a, 05c49308, 0aefc0c8 |
...
- **§56** `on_core_unsupported`: общий гейт узла на сборке не сделан. Гейт
  Tailscale у нас — по версии (`kTailscaleMinCoreVersion`), реестр гейтит
  по `build_tag`, строки `Tags:` у нас нет — свести значит снять гейт.
  Подпись уровня (`levels`) — закрыто UI-волной, см. ниже.
