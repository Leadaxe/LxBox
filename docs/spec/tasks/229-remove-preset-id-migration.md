...
> **СТАТУС: ВЫПОЛНЕНО (2026-07-26).** Условие выдержано с запасом: §228 вышел в
> **v2.10.0**, снятие сделано в разработке после **v2.17.0** — порядка
> пятнадцати релизных циклов вместо требуемого одного.
