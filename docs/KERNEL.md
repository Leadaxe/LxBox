...
**The current pin: `v1.14.2-lx.3`** (see `app/android/libbox.version`) — lx.1
plus XHTTP HTTP-version parity (**SPEC 104**, lx.2) and Vision on top of VLESS
Encryption (**SPEC 105**, lx.3). The `lx.1` layers: **SPEC 097**, **SPEC 098**,
