...
**The current pin: `v1.14.0-lx.36`** (see `app/android/libbox.version`) —
two hotfixes on the same upstream base as lx.34 (sing-box 1.14.0 + 16
post-release commits); nothing in the configuration or on the wire changes.
