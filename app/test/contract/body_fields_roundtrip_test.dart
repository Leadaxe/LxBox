...
const kNotModelled = <String, String>{
  ...
  'socks.version': '§475 — версия SOCKS по схеме ссылки, отдельная задача',
  ...
  // Ключи WG нормализуются в std-base64 с паддингом (§106, D-030): те же 32
  // байта в другом написании. Круг сравнивает строки, поэтому расхождение
  // видит; потерей оно не является.
  'wireguard.private_key': 'ключ канонизируется в std-base64 (§106, D-030)',
  'wireguard.header_protection_key': 'ключ канонизируется в std-base64 (§421)',
  'wireguard.peers': 'ключи пира канонизируются в std-base64 (§106, D-030)',
