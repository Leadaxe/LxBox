      ...
      children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'AND with match. Transport (L4) and L7 sniff.',
                      style: TextStyle(
                        fontSize: 12,
        ...
        if (!hasAny)
          Padding(
            ...
            child: Text(
              'Any — tap Edit to filter by network / L7 protocol',
              style: TextStyle(
                fontSize: 13,
                color: t.colorScheme.onSurfaceVariant,
              ),
    ...
    return SafeArea(
      child: Padding(
        ...
        child: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('Protocol filter', style: t.textTheme.titleMedium),
            const SizedBox(height: 2),
            Text(
              'Matches when traffic is on a selected network AND matches a '
              'selected L7 protocol.',
              style: TextStyle(
                fontSize: 12,
                color: t.colorScheme.onSurfaceVariant,
              ),
