...
/// Bottom-sheet — `Wrap`, так что длина не ограничена версткой. Сгруппировано
/// по смыслу: сеть/статус · VPN-транспорты (☁️ WARP, 🎭 MASQUE, ⛈️ AWG — что
/// проект ставит сам) · флаги популярных стран-выходов · разное.
const List<String> kEmojiPalette = [
  // сеть / статус
  '🏠', '⚡', '🚀', '🔁', '⚙', '⭐', '🌍', '🔒',
  '🔓', '🛡️', '🚦', '📡', '🔑', '✅', '❤️', '🔥',
  // VPN-транспорты / провайдеры
  '☁️', '🎭', '⛈️', '🐝', '🦊', '🐧', '🌀',
  // флаги популярных стран-выходов
  '🇺🇸', '🇬🇧', '🇩🇪', '🇳🇱', '🇫🇷', '🇸🇪', '🇫🇮', '🇨🇭',
  '🇯🇵', '🇸🇬', '🇭🇰', '🇰🇷', '🇹🇷', '🇦🇪', '🇷🇺', '🇺🇦',
  '🇰🇿', '🇬🇪', '🇦🇲', '🇮🇳', '🇨🇦', '🇦🇺', '🇧🇷', '🇵🇱',
  // разное
