...
/// Заводить на это per-app override нельзя (инвариант 1 спеки), а
/// суppress-правила «код только на входе body» реестр не знает:
/// `except_sources` (§473, контракт 1.1.5) объявлен ровно для `max_when`.
///
