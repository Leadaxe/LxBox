...
Ядро: **sing-box-lx `v1.14.0-lx.19-rc.3`** (без изменений).

Релиз целиком из ревизии кода за два месяца работ (§068→§346): инспекция
суммарного диффа, фиксы найденного, актуализация документации и спек.
Новых функций нет.
