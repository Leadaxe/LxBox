...
- **Узлы trojan, vless, vmess и shadowsocks из ссылок разбираются общим
  конвейером, и предупреждений у них стало больше — с адресом поля
  ([§472](docs/spec/features/472%20unified-parse-pipeline/spec.md), шаги 2–4).**
  ...
  причиной. Тела узлов, их имена и идентичность не изменились — выбор узла,
