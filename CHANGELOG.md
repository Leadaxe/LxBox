...
Первые шаги к поддержке Android TV (§372). Приложение появляется в
телевизионном лаунчере, а два места, где оно было нерабочим на TV, починены:
импорт из файла и навигация пультом. Полноценного телевизионного интерфейса
нет — вёрстка по-прежнему рассчитана на телефон, поддержка остаётся
best-effort. Проверено на эмуляторе Android TV; на реальном телевизоре
(Android 7.1.1, откуда пришла жалоба) ещё не подтверждено.
