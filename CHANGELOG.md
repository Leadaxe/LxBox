...
- **Узлы trojan, vless, vmess, shadowsocks и hysteria2 из ссылок разбираются
  общим конвейером, и предупреждений у них стало больше — с адресом поля
  ...
  остальное. Тела узлов, их имена и идентичность не изменились — выбор узла,
  отключения и цепочки на месте. Остальные протоколы разбираются по-прежнему;
  они переезжают следующими шагами.
